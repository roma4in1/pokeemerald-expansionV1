#!/usr/bin/env python3
"""Generate stub scripts.inc for every Primalis map so map.json script references
...
wiring (not a stub) - it sets VAR_TEMP_1 = PELAGIOS_ISLAND_PRIMALIS and gotos the
...
TENNYSON_LABEL = 'PrimalisVerdantLanding_EventScript_Tennyson'
TENNYSON_BODY = (
    f'@ Boat-boarding wiring (map-builder owns this; NOT dialogue).\n'
    f'{TENNYSON_LABEL}::\n'
    '\tlockall\n'
    '\tsetvar VAR_TEMP_1, PELAGIOS_ISLAND_PRIMALIS\n'
