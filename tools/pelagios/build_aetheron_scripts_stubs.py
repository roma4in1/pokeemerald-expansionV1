#!/usr/bin/env python3
"""Generate stub scripts.inc for every Aetheron map so map.json script references
resolve at link time. Mirrors build_ashenveil_scripts_stubs.py.
...
EXCEPTION: CloudLanding's *_EventScript_Tennyson is written as REAL boat-boarding
wiring (not a stub) - it sets VAR_TEMP_1 = PELAGIOS_ISLAND_AETHERON and gotos the
...
TENNYSON_LABEL = 'AetheronCloudLanding_EventScript_Tennyson'
TENNYSON_BODY = (
    f'@ Boat-boarding wiring (map-builder owns this; NOT dialogue).\n'
    f'{TENNYSON_LABEL}::\n'
    '\tlockall\n'
    '\tsetvar VAR_TEMP_1, PELAGIOS_ISLAND_AETHERON\n'
